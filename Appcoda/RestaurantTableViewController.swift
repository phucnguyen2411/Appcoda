...
class RestaurantTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.imageRes.image = UIImage(named: restaurants[indexPath.row].image)
        cell.nameRes.text = restaurants[indexPath.row].name
        cell.locationRes.text = restaurants[indexPath.row].location
        //Custom image
        cell.imageRes.layer.cornerRadius = 30.0
        let red = UIColor(red: 100.0/255.0, green: 130.0/255.0, blue: 230.0/255.0, alpha: 1.0)
        cell.imageRes.layer.borderColor = red.CGColor
    ...
    */
    ...
    override func tableView(tableView: UITableView, editActionsForRowAtIndexPath indexPath: NSIndexPath) -> [UITableViewRowAction]? {
        ...
        let shareAction = UITableViewRowAction(style: .Default, title: "Share", handler: {
            ...
            let defaultText = "Just Sharing" + self.restaurants[indexPath.row].name
